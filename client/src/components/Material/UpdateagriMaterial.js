...
export default function UpdateagriMaterial() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3001/getagri/${id}`)
...
function submit(event){
  event.preventDefault();
   axios.put(`http://localhost:3001/agriupdate/${id}`,{
    "addeddate":addeddate,
